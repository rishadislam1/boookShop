...
import { useDeleteBookMutation, useGetCommentQuery, usePostCommentMutation, useSingleBookQuery } from "../../Redux/feature/books/bookApi";
...
const BookDetails = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center mt-10">
      ...
      {/* eidt delete */}
    <div className="mt-28">
        <button onClick={handleEdit} className="px-10 py-2 text-white bg-green-500 rounded-xl">Edit</button> <br /> <br />
        <button onClick={handleDelete} className="px-10 py-2 text-white bg-red-500 rounded-xl">Delete</button>
      </div>
